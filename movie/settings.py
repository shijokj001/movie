...
assert DEBUG or '*' not in ALLOWED_HOSTS, 'Wildcard ALLOWED_HOSTS are not allowed'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='movie'),
        'USER': config('DATABASE_USERNAME', default='smartpool'),
